...
namespace pjpl {
    ...
    namespace wstr {
        const std::vector<std::wstring> limToken = {
            L"=" ,
            L"=[",
            L"![",
            L"!=",
         ...
         * @return
         */
        std::wstring adjustToken(const std::wstring &exp, size_t startPos, const std::vector<std::wstring> &tokens);
        /**
         * Zwraca token z listy tokens jeżeli zaczyna się bezpośrednio na pozycji startPos
         * @param exp
         * @param startPos
         ...
         * @return
         */
        std::wstring adjustNearestToken(const std::wstring &exp, size_t &start, size_t &stop, const std::vector<std::wstring> &tokens);
         ...
         * - liczba naukowa
         */
        std::wstring token(const std::wstring &str,size_t &start,size_t &stop);

        std::wstring trim(const std::wstring &buf);
         ...
         * @return
         */
        std::vector<std::wstring> split(const std::wstring& string, const std::wstring& rozdzielnik, bool trim = false);
    }
